...
export class ServerManager {
    static STORAGE_KEY = "cd_servers";
    static STATUS_CACHE_KEY = "cd_server_status";
    static SELECTED_SERVER_KEY = "cd_selected_server";
     ...
     */
    static async checkServerAvailability(server) {
     ...
     */
    static getCachedStatus(serverId) {
        try {
     ...
     * @param serverId - ID сервера
     */
    static setSelectedServerId(serverId) {
        try {
