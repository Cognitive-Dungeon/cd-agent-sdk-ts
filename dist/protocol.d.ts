 ...
 */
export type ClientToServerAction = "LOGIN" | "MOVE" | "ATTACK" | "TALK" | "INTERACT" | "WAIT" | "PICKUP" | "DROP" | "USE" | "EQUIP" | "UNEQUIP" | "CUSTOM";
/**
 ...
 * ```
 */
export declare function serializeClientCommand(command: ClientToServerCommand): string;
